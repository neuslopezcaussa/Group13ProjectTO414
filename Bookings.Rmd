...
summary(model2)
model2_pred = predict(model2, type = 'response', newdata = bookings_test[-3])
y_pred = ifelse(model2_pred > 0.5, 1, 0)
cm = table(bookings_test[, 3], y_pred > 0.5)
cm
```

```{r}
## DATA CLEANING BLOCK FOR TESTING, DO NOT INCLUDE IN FINAL RESULT
